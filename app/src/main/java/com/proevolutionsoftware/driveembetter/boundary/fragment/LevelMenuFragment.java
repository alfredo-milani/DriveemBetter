...
import com.proevolutionsoftware.driveembetter.adapters.LevelMenuRecyclerViewAdapter;
...
public class LevelMenuFragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (android.os.Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT){
            ...
            titleDivider.setBackgroundColor(ContextCompat.getColor(context, R.color.colorPrimaryDark));
        }
