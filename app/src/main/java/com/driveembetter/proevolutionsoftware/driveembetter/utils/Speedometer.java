...
public class Speedometer extends View implements SpeedChangeListener {
	...
	private void initDrawingTools(){
		...
		scalePaint.setShadowLayer(5f, 0f, 0f, Color.BLACK);
		...
		readingPaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/digital-7.ttf"));
...
//		Log.d(TAG, "Height spec: " + MeasureSpec.toString(heightMeasureSpec));
	...
	private void drawReading(Canvas canvas){
		Path path = new Path();
		String message = String.format("%d km/h", (int)this.mCurrentSpeed);
